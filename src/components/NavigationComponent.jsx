  ...
  return (
    <nav className="
      ...
      <div className="flex items-center gap-6 h-full">
        <a onClick={linkClickSidebarCheck} className={`px-2 py-1 rounded-md transition-colors ${activeHash === "#portfolio" ? "text-accent-500 font-medium" : "text-main-700 hover:text-accent-500"}`} href="#portfolio">Projects</a>
        <a onClick={linkClickSidebarCheck} className={`px-2 py-1 rounded-md transition-colors ${activeHash === "#about" ? "text-accent-500 font-medium" : "text-main-700 hover:text-accent-500"}`} href="#about">About</a>
        <a onClick={linkClickSidebarCheck} className={`px-2 py-1 rounded-md transition-colors ${activeHash === "#contact" ? "text-accent-500 font-medium" : "text-main-700 hover:text-accent-500"}`} href="#contact">Contact</a>
